...
fun AmortizationScreen(
    ...
    deletingEntry?.let { entry ->
        AdAwareAlertDialog(
            ...
            dismissButton = {
                DialogSecondaryButton(onClick = { deletingEntry = null }) { Text(S.common.cancel) }
            }
        )
    }
        ...
        Surface(
            ...
            Column {
                ...
                Column(
                    ...
                    OutlinedTextField(
                        value = source,
                        onValueChange = { source = if (autoCapitalize) com.techadvantage.budgetrak.data.toApaTitleCase(it) else it },
