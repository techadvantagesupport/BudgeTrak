...
data class CommonStrings(
    ...
    val applyToPastTitle: String,
    val applyToPastBody: String,
    val applyToPastConfirm: String,
    val applyToPastDeny: String,
...
data class DashboardStrings(
    ...
    val noSavingsGoalsConfigured: String,
...
data class SettingsStrings(
    ...
    val spanish: String,
    // Receipt Photos
    val receiptPhotosSection: String,
    val cacheSize: (String) -> String,
    val receiptRetention: String,
    val keepAll: String,
    val days30: String,
    val days60: String,
    val days90: String,
    val days180: String,
    val days365: String,
    val adminOnlyRetention: String,
    // Backups
    val backupsSection: String,
    val enableAutoBackups: String,
    val lastBackupLabel: String,
    val nextBackupLabel: String,
    ...
    val weeks2: String,
    val weeks4: String,
    val retentionAll: String,
    val leaveGroupToRestore: String,
    // Backup dialogs
    val setBackupPassword: String,
    ...
    val enableBackups: String,
    val disableBackups: String,
    val keepOrDeletePrompt: String,
    val deleteAllConfirmMsg: String,
    val deleteAllBtn: String,
...
data class TransactionsStrings(
    ...
    val recurringFilter: String,
    val excludedFilter: String,
    val notVerifiedFilter: String,
    val photosFilter: String,
    ...
    val incomeSourceLabel: String,
    val amortizationEntryLabel: String,
    val recurringExpenseLabel: String,
...
data class SettingsHelpStrings(
    ...
    val receiptPhotosBullet1: String,
    val receiptPhotosBullet2: String,
    val receiptPhotosBullet3: String,
    val receiptPhotosRetentionTitle: String,
    val receiptPhotosRetentionBody: String,
    val receiptPhotosRetentionNote: String,
    ...
    val backupsBody: String,
    val backupsEnableBullet: String,
    val backupsFrequencyBullet: String,
    val backupsRetentionBullet: String,
    val backupsPasswordWarning: String,
    val backupsOffPhoneTip: String,
    val backupsRestoreTitle: String,
    val backupsRestoreBody: String,
    val backupsRestoreBullet1: String,
    val backupsRestoreBullet2: String,
    val backupsRestoreBullet3: String,
    val backupsRestoreBullet4: String,
    val backupsRestoreNote: String,
    // Backup encryption explanation (moved from transactionsHelp; the manual
    // encrypted save format was removed but the same encryption logic powers
    // the auto-backup feature, so the explanation lives here now).
    val backupEncryptionTitle: String,
    val backupEncryptionBody: String,
...
data class TransactionsHelpStrings(
    ...
    val sortButtonDesc: String,
    val rangeButtonDesc: String,
    ...
    val xlsxFormatTitle: String,
    val xlsxFormatBody: String,
    val pdfReportFormatTitle: String,
    val pdfReportFormatBody: String,
    val loadingTitle: String,
    val loadingBody: String,
    val loadGeneric: String,
    val loadGenericDesc: String,
...
data class RecurringExpensesHelpStrings(
    ...
    val setAsideProgressBody: String,
    val actionsTitle: String,
    val editNote: String,
    val repeatSettingsDesc: String,
    val deleteDesc: String,
    val acceleratedTitle: String,
    val acceleratedBody: String,
    ...
    val linkingTitle: String,
    val linkingBody: String,
    val linkingBullet1: String,
    val linkingBullet2: String,
    val linkingBullet3: String,
    val tipsTitle: String,
    val tip1: String,
    val tip2: String,
    val tip3: String,
...
data class SyncHelpStrings(
    ...
    // Admin Features and Decisions
    val adminFeaturesTitle: String,
    val adminFeaturesIntro: String,
    val adminFeatureBudgetTitle: String,
    val adminFeatureBudgetBody: String,
    val adminFeatureCurrencyTitle: String,
    val adminFeatureCurrencyBody: String,
    val adminFeatureTimezoneTitle: String,
    val adminFeatureTimezoneBody: String,
    val adminFeatureAttributionTitle: String,
    val adminFeatureAttributionBody: String,
    val adminFeatureRetentionTitle: String,
    val adminFeatureRetentionBody: String,
    val adminFeatureManageTitle: String,
    val adminFeatureManageBody: String,
    val gettingStartedTitle: String,
    val gettingStartedBody: String,
