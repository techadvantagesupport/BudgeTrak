package com.techadvantage.budgetrak.ui.strings
...
object SpanishStrings : AppStrings {
    ...
    override val dashboard = DashboardStrings(
        ...
        noSavingsGoalsConfigured = "No hay metas de ahorro configuradas",
    ...
    override val settings = SettingsStrings(
        ...
        aiOcrAddReceiptFirst = "Agrega primero una foto del recibo",
        aiOcrHighlightFirst = "Mant\u00e9n presionada una foto para destacarla como objetivo del escaneo",
        ...
        aiOcrHelpBody = "Los suscriptores pueden tocar el icono de la chispa en el di\u00e1logo de transacci\u00f3n para rellenar autom\u00e1ticamente el comerciante, la fecha, el importe y la categor\u00eda a partir de la foto del recibo.\n\nElegir qu\u00e9 foto escanear: mant\u00e9n presionada una miniatura en la barra de fotos para destacarla con un contorno azul \u2014 esa foto se convierte en el objetivo del escaneo. Mant\u00e9nla presionada de nuevo para quitar la selecci\u00f3n, o mant\u00e9n presionada otra miniatura para cambiar el objetivo. Las fotos complementarias (primeros planos, fachada, etc.) pueden quedarse sin resaltar en las otras ranuras. Si tocas la chispa sin destacar una foto, un aviso te recordar\u00e1 que mantengas presionada una primero.\n\nReordenar fotos: despu\u00e9s de mantener presionada una miniatura (sin levantar el dedo), des\u00ed\u00adzala a la izquierda o a la derecha sobre las otras fotos y la fila se reorganizar\u00e1 en tiempo real. Suelta para confirmar el nuevo orden.\n\nEliminar una foto: toca la miniatura para abrir la vista a pantalla completa y usa el bot\u00f3n de eliminar que aparece all\u00ed.\n\nRecibos sincronizados: si una foto se a\u00f1adi\u00f3 en otro dispositivo y todav\u00eda no termin\u00f3 de descargarse aqu\u00ed, ver\u00e1s un marcador con un icono de c\u00e1mara. Puedes reordenarlo como una foto normal; al tocarlo aparecer\u00e1 un aviso breve indicando que la descarga sigue en curso.",
        aiOcrPreselectBanner = "\u00a1Lee la secci\u00f3n de ayuda (?) sobre categor\u00edas preseleccionadas y el comportamiento del escaneo de recibos!",
        aiOcrPreselectHelpTitle = "Categor\u00edas preseleccionadas y escaneo de recibos",
        aiOcrPreselectHelpBody = "C\u00f3mo la divisi\u00f3n de categor\u00edas de la IA depende de lo que ya tengas seleccionado en el di\u00e1logo:\n\n\u2022 Sin categor\u00edas seleccionadas \u2014 la IA puede elegir libremente de tu lista completa de categor\u00edas y asignar\u00e1 las que crea que mejor encajan con los art\u00edculos del recibo. Este es el modo correcto para un recibo nuevo en el que a\u00fan no has decidido una categor\u00eda.\n\n\u2022 Categor\u00edas preseleccionadas \u2014 a la IA se le indica considerar solo esos buckets. Repartir\u00e1 los art\u00edculos del recibo entre las que elegiste (y omitir\u00e1 una categor\u00eda preseleccionada si nada del recibo encaja razonablemente, en lugar de forzar un ajuste).\n\nImportante: la IA NO cambia tu selecci\u00f3n de categor\u00edas. Las casillas marcadas cuando tocas la chispa siguen marcadas despu\u00e9s; la IA solo rellena los importes. Eso significa que si est\u00e1s editando una transacci\u00f3n existente donde (por ejemplo) solo Otros est\u00e1 seleccionada, la IA colocar\u00e1 todo el total del recibo en Otros \u2014 no a\u00f1adir\u00e1 Comestibles ni Suministros del Hogar aunque detecte esos art\u00edculos.\n\nPara que la IA analice las categor\u00edas desde cero en una transacci\u00f3n existente, deselecciona primero todas las categor\u00edas y luego toca la chispa.",
    ...
    override val transactions = TransactionsStrings(
        ...
        recurringFilter = "Recurrentes",
        excludedFilter = "Excluidas",
        notVerifiedFilter = "Sin verificar",
        photosFilter = "Fotos",
        sortDateDesc = "Fecha \u2193",
        sortDateAsc = "Fecha \u2191",
        ...
        importAiNetworkHint = "Con\u00e9ctate a Wi-Fi o datos m\u00f3viles antes de importar para obtener la mejor categorizaci\u00f3n.",
        importAiBusy = "Categorizando transacciones con IA\u2026",
    ...
    override val sync = SyncStrings(
        ...
        claimApproved = "Has sido aprobado como nuevo administrador.",
        claimRejected = "Tu solicitud para asumir las funciones de administrador fue rechazada.",
    ...
    override val settingsHelp = SettingsHelpStrings(
        ...
        receiptPhotosBody = "Los usuarios de pago pueden adjuntar hasta 5 fotos por transacci\u00f3n. Desliza a la izquierda en una transacci\u00f3n para ver el panel de fotos, o usa el icono de c\u00e1mara en el di\u00e1logo de edici\u00f3n. Se admiten tanto im\u00e1genes como PDFs; los PDFs se convierten en imagen al importarlos.\n\nInteractuar con la barra de fotos: toca una miniatura para abrir la vista a pantalla completa (con un bot\u00f3n Eliminar). Mant\u00e9n presionada una miniatura para recogerla y arrastrarla a la izquierda o a la derecha para reordenarlas \u2014 las otras fotos se apartan en tiempo real.\n\nRecibos sincronizados: si una foto se a\u00f1adi\u00f3 en otro dispositivo y su archivo todav\u00eda no se descarg\u00f3 aqu\u00ed, ver\u00e1s un marcador con icono de c\u00e1mara. A\u00fan puedes reordenarlo; al tocarlo aparecer\u00e1 un breve aviso indicando que la descarga est\u00e1 en curso.",
    ...
    override val simulationGraphHelp = SimulationGraphHelpStrings(
        ...
        overviewBody = "La Simulaci\u00f3n de Flujo de Caja proyecta tu trayectoria financiera durante los pr\u00f3ximos 18 meses. " +
            ...
            "La Simulaci\u00f3n de Flujo de Caja es una funci\u00f3n de pago \u2014 \u00e1brela desde el \u00edcono " +
