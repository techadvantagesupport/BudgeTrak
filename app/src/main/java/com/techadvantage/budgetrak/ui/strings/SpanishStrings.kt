...
object SpanishStrings : AppStrings {
    ...
    override val settings = SettingsStrings(
        ...
        aiCsvCategorizeHelpBody = "Cuando est\u00e1 activada, BudgeTrak env\u00eda el comerciante, el importe y la fecha de las transacciones reci\u00e9n importadas desde un CSV bancario a la IA Gemini de Google para elegir la mejor categor\u00eda.\n\nBudgeTrak ya aprende de tus transacciones anteriores en el dispositivo; la IA solo interviene con comerciantes desconocidos que el emparejador local no puede resolver con confianza. Con\u00e9ctate a Wi-Fi o datos m\u00f3viles antes de importar para obtener los mejores resultados.\n\nTus datos se cifran en tr\u00e1nsito (HTTPS) y Google los elimina al completar la solicitud \u2014 no se guarda nada en los servidores de Google. El proveedor de IA nunca ve tu cuenta, tus saldos, otras transacciones, ni las fotos de recibos.\n\nDesact\u00edvalo cuando quieras para volver al emparejador local de BudgeTrak \u00fanicamente.",
