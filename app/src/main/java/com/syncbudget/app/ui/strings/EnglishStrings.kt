...
object EnglishStrings : AppStrings {
    ...
    override val settings = SettingsStrings(
        ...
        noBackupsFound = "No backups found in Download/BudgeTrak/backups/",
    ...
    override val settingsHelp = SettingsHelpStrings(
        ...
        backupsRestoreBullet2 = "If you are in a group, leave the group first",
        backupsRestoreBullet3 = "After restoring, re-create or rejoin your group",
        backupsRestoreBullet4 = "Other devices will receive the restored data through sync",
